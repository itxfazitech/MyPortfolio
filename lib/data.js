...
/* ------------------------------------------------------------------ */
export const ABOUT = {
  headline: "Systems Architect & Full-Stack Engineer",
  bio: [
    "I'm a multi-platform systems architect with 8+ years of experience building complete digital ecosystems for businesses of all sizes.",
    "My work spans web, mobile, desktop, and enterprise systems — not just interfaces, but the entire stack: databases, APIs, business logic, deployment pipelines, and everything in between.",
    "I approach every project as a system design challenge. Whether it's an ERP for 500 employees or a marketplace handling millions in transactions, I architect solutions that are modular, scalable, and built to last.",
  ],
  philosophy: {
